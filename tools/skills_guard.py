...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.(?:hermes|hermes-home)/\.env|\~/\.(?:hermes|hermes-home)/\.env|\$HERMES_HOME/\.env|\$\{HERMES_HOME\}/\.env',
    ...
    (r'\.(?:hermes|hermes-home)/config\.yaml|\.(?:hermes|hermes-home)/SOUL\.md|HERMES_HOME/config\.yaml|HERMES_HOME/SOUL\.md',
